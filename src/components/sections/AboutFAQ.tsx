...
export default function AboutFAQ() {
  ...
  return (
    <section className="px-[2.4rem] py-12 sm:py-20 border-t border-white/[0.06]">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-x-4 sm:gap-x-[2.4rem] lg:gap-x-[3.6rem]">
        {/* Col 1: Number label — aligned with 001 */}
        ...
        {/* Col 2: Title + FAQs — aligned with Agency & Studio */}
